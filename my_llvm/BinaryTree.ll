...
L1:
	...
	br i1 %_189, label %L3, label %L4
L3:
	br label %L5
L4:
	br label %L5
L5:
	%_190 = phi i1 [0, %L3], [1, %L4]
	br i1 %_190, label %L6, label %L7
L6:
	store i1 0, i1* %ntb
...
L9:
	...
	br i1 %_203, label %L10, label %L11
L10:
	...
	br i1 %_213, label %L12, label %L13
L12:
	...
	br i1 %_220, label %L15, label %L16
L15:
...
L13:
	...
	br i1 %_249, label %L18, label %L19
L18:
...
L21:
	...
	br i1 %_272, label %L22, label %L23
L22:
	...
	br i1 %_282, label %L24, label %L25
L24:
	...
	br i1 %_289, label %L27, label %L28
L27:
...
L25:
	...
	br i1 %_300, label %L30, label %L31
L30:
	...
	br i1 %_307, label %L33, label %L34
L33:
...
L31:
	...
	br i1 %_316, label %L36, label %L37
L36:
	...
	br i1 %_323, label %L39, label %L40
L39:
	br label %L41
L40:
	br label %L41
L41:
	%_324 = phi i1 [0, %L39], [1, %L40]
	br i1 %_324, label %L46, label %L45
L45:
	br label %L48
L46:
	...
	br i1 %_331, label %L42, label %L43
L42:
	br label %L44
L43:
	br label %L44
L44:
	%_332 = phi i1 [0, %L42], [1, %L43]
	br label %L47
L47:
	br label %L48
L48:
	%_333 = phi i1 [0, %L45], [%_332, %L47]
	br i1 %_333, label %L49, label %L50
L49:
	store i1 1, i1* %ntb
...
define i1 @Tree.Remove(i8* %this, i8* %.p_node, i8* %.c_node) {
	...
	br i1 %_357, label %L52, label %L53
L52:
...
L53:
	...
	br i1 %_372, label %L55, label %L56
L55:
...
L56:
	...
	br i1 %_408, label %L58, label %L59
L58:
...
L61:
	...
	br i1 %_449, label %L62, label %L63
L62:
...
L64:
	...
	br i1 %_501, label %L65, label %L66
L65:
...
L67:
	...
	br i1 %_547, label %L68, label %L69
L68:
	...
	br i1 %_557, label %L70, label %L71
L70:
	...
	br i1 %_564, label %L73, label %L74
L73:
...
L71:
	...
	br i1 %_574, label %L76, label %L77
L76:
	...
	br i1 %_581, label %L79, label %L80
L79:
...
define i1 @Tree.RecPrint(i8* %this, i8* %.node) {
	...
	br i1 %_603, label %L82, label %L83
L82:
...
L84:
	...
	br i1 %_630, label %L85, label %L86
L85:
